...
namespace WebLogistica.Web.Domain
{
	public class NavbarData
	{
		public IEnumerable<Navbar> NavbarItems()
		{
			...
			menu.Add(new Navbar { Id = 2, nameOption = "Planilla Envios", controller = "Envios", action = "Salientes", imageClass = "fa fa-fw fa-arrow-right", isParent = false, parentId = -1 });
			menu.Add(new Navbar { Id = 3, nameOption = "Consulta Clientes", controller = "ClientesTransportistas", action = "Listado", imageClass = "fa fa-fw fa-users", isParent = false, parentId = -1 });
